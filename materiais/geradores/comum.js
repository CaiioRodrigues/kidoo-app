          ...
          new TableCell({
            ...
            children: [
              new Paragraph({
                ...
                spacing: { after: 0 },
                children: [
                  new TextRun({ text: 'K', font: FONTE, size: 26, bold: true, color: 'FFFFFF' }),
                ],
              }),
            ],
          }),
...
function titulo(t, sub) {
  return [
    new Paragraph({
      ...
      children: [new TextRun({ text: t, font: FONTE, size: 44, bold: true, color: TINTA })],
    }),
...
function pergunta(n, t, nota) {
  ...
  if (nota)
    filhos.push(
      new TextRun({ text: '  ' + nota, font: FONTE, size: 18, italics: true, color: FRACO }),
    );
  return new Paragraph({
      ...
      new TableCell({
        ...
        children: [
          new Paragraph({
            ...
            spacing: { after: 0 },
            children: [
              new TextRun({ text: String(i), font: FONTE, size: 21, bold: true, color: ROXO }),
            ],
          }),
        ],
      }),
    ...
    new Table({
      ...
      rows: [
        new TableRow({
          children: [
            new TableCell({
              width: { size: Math.floor((LARGURA - 260) / 2), type: WidthType.DXA },
              margins: { top: 40 },
              children: [
                new Paragraph({
                  spacing: { after: 0 },
            ...
            new TableCell({
              width: { size: Math.ceil((LARGURA - 260) / 2), type: WidthType.DXA },
              margins: { top: 40 },
              children: [
                new Paragraph({
